...
class WbGrawler():
    def __init__(self,start=1,end=500):
        ...
        :return:
        """
        self.baseurl = "https://m.weibo.cn/api/container/getIndex?containerid=2304133175311821&"
        self.headers = {
            "Host": "m.weibo.cn",
            "Referer":"https://m.weibo.cn/p/2304133175311821",
        ...
        self.end_pages = end
        # 图片保存位置
        self.path = "F:/tools/photowall/images/"
